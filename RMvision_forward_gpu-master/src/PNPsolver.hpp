...
public:
    ...
    /*函数*/
    int calculate_single(yolo_kpt::Object &armor);//单目标解算
    int calculate_all(std::vector<yolo_kpt::Object> &armors);//批量解算
    pnp_solver(const std::string& filename);//初始化时从YAML文件加载相机参数
